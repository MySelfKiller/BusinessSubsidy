...
//                    LogUtil.e("hm","------token_key-----"+SMApplication.instance.token)
                }
                LogUtil.e("hm","------saveFromResponse-----")
...
//        SharedPreferences sp = SMApplication.getInstance().getApplicationContext().getSharedPreferences(Constants.SharedPreferences_name, MODE_PRIVATE);
