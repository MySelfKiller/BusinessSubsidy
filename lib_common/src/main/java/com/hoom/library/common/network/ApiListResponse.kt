 ...
 */
data class ApiListResponse<T>(val code: Int, val count: String, val list: T) : BaseResponse<T>() {

    override fun isSucces() = code == 1

    override fun getResponseCode() = code

    override fun getResponseData() = list

    override fun getResponseMsg() = count
