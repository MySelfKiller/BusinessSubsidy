...
//        context.registerReceiver(receiver, filter);
    ...
    public WXShare getAuth(ItemCallback callback) {
        ...
        if (!api.isWXAppInstalled()) {
            ...
            req.state = "com.kayu.business.subsidy";
            api.sendReq(req);
            this.callback = callback;
        }
        return this;
    ...
    public WXShare shareText(int type, String text) {
        ...
        LogUtil.INSTANCE.e("hm", "text shared: " + result);
        return this;
    }
    ...
    public WXShare shareImg(int type, String filePath) {
        ...
        msg.thumbData = FileUtil.Companion.bmpToByteArray(thumbBmp, true);
...
//调用api接口，发送数据到微信
    ...
    private class ResponseReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            LogUtil.INSTANCE.e("hm", "接收到广播");
            if (intent.getAction().equals(WXShare.TYPE_SHARE)) {
                Response response = intent.getParcelableExtra(EXTRA_RESULT);
                LogUtil.INSTANCE.e("hm", "type: " + response.getType());
                LogUtil.INSTANCE.e("hm", "errCode: " + response.errCode);
                String result;
                if (listener != null) {
                ...
                LogUtil.INSTANCE.e("hm", "code: " + code);
                if (null != callback) {
