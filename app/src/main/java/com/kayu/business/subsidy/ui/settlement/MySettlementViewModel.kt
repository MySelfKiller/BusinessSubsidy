...
@HiltViewModel
class MySettlementViewModel @Inject constructor(private val mRepository: MainRepository) : BaseViewModel() {
    var isLoadMore = false
    var isRefresh = false
    var pageIndex = 0
    var adapter: BaseQuickAdapter<SettlementBean, BaseDataBindingHolder<ItemMySettlementLayBinding>>? = null
