package com.hoom.library.base.utils.status.imp

import android.os.Bundle
import com.hoom.library.base.utils.status.ViewStatusHelper
...
open class BaseFrameViewStatusHelperImp(parentViewStatusHelper: ViewStatusHelper? = null) : ViewStatusHelper(parentViewStatusHelper) {
     ...
     */
    private val KEY_RECREATE = "com.hoom.library.base.utils.status.BaseFrameViewStatusHelperImp.Recreate"
