...
public class CommonTabLayout extends FrameLayout implements ValueAnimator.AnimatorUpdateListener {
    ...
    private GradientDrawable mIndicatorDrawable2 = new GradientDrawable();
    ...
    private boolean tabBackgroundVisible;//是否显示设置Tab背景色块
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        mIndicatorColorEnd = ta.getColor(R.styleable.CommonTabLayout_tl_indicator_color_end, Color.parseColor((mIndicatorStyle == STYLE_BLOCK || mIndicatorStyle == STYLE_STORKE) ? "#4B6A87" : "#ffffff"));
        tabBackgroundVisible = ta.getBoolean(R.styleable.CommonTabLayout_tl_tab_backgroundVisible, false);
        mIndicatorColor2 = ta.getColor(R.styleable.CommonTabLayout_tl_indicator_color2, Color.parseColor((mIndicatorStyle == STYLE_BLOCK || mIndicatorStyle == STYLE_STORKE) ? "#4B6A87" : "#ffffff"));
        ...
        mIconWidth = ta.getDimension(R.styleable.CommonTabLayout_tl_iconWidth, dp2px(20));
        mIconHeight = ta.getDimension(R.styleable.CommonTabLayout_tl_iconHeight, dp2px(20));
...
//        Log.d("AAA", "mCurrentP--->" + mCurrentP.left + "&" + mCurrentP.right);
    ...
    public void drawTabBackGround(Canvas canvas){
        int height = getHeight();
        int paddingLeft = getPaddingLeft();
        for (int i = 0; i < mTabCount ; i++) {
            ...
            if (mIndicatorHeight > 0) {
                ...
                mIndicatorDrawable2.setColor(mIndicatorColor2);
                mIndicatorDrawable2.setBounds( paddingLeft + (int) mIndicatorMarginLeft + tab.getLeft(),
                        (int) mIndicatorMarginTop, (int) (paddingLeft + tab.getRight() - mIndicatorMarginRight),
                        (int) (mIndicatorMarginTop + mIndicatorHeight));
                mIndicatorDrawable2.setCornerRadius(mIndicatorCornerRadius);
...
//                mIndicatorRect.left = paddingLeft + (int) mIndicatorMarginLeft + currentTabView.getLeft();
//                mIndicatorRect.right = (int) (mIndicatorRect.left + mIndicatorWidth);
//            }
        }
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mIndicatorStyle == STYLE_TRIANGLE) {
            ...
            if (mIndicatorHeight > 0) {
                ...
                if (mIndicatorColorEnd == Color.parseColor("#4B6A87") ||mIndicatorColorEnd == Color.parseColor("#ffffff")){
