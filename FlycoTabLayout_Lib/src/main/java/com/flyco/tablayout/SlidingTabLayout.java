...
public class SlidingTabLayout extends HorizontalScrollView implements ViewPager.OnPageChangeListener {
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        tabBackgroundVisible = ta.getBoolean(R.styleable.SlidingTabLayout_tl_tab_backgroundVisible, false);
        mIndicatorColor2 = ta.getColor(R.styleable.SlidingTabLayout_tl_indicator_color2, Color.parseColor(mIndicatorStyle == STYLE_BLOCK ? "#4B6A87" : "#ffffff"));
